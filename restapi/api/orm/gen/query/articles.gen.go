...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.ContentID = field.NewInt64(tableName, "content_id")
	_article.Subtitle = field.NewString(tableName, "subtitle")
	_article.Body = field.NewString(tableName, "body")
	_article.Remarks = field.NewString(tableName, "remarks")
	_article.Deleted = field.NewBool(tableName, "deleted")
...
func (a *article) updateTableName(table string) *article {
	...
	a.ContentID = field.NewInt64(table, "content_id")
